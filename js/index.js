(function () {
  const projects = [
    {
      title: 'Hackter méxico',
      image: './img/projects/hackterfull.png',
      imageAlt: 'Chrome Extension Project Cover Photo',
      description: 'Hackter es una escuela en la que aprenderás a programar y a crear productos de software innovadores',
      badgeCaption: 'Chrome Extension',
      links: {
        github: 'https://github.com/jibsamGarcia?tab=repositories',
        chrome: 'https://www.instagram.com/garciajibsam/'
      },
      accomplishments: [
        'Javascript',
    ...
    {
      title: 'Instituto OWL',
      image: './img/projects/instituto.png',
      imageAlt: 'Favorite OWL Photo',
      description: 'Instituto OWL Comunidad Educativa.',
      ...
      accomplishments: [
        ...
        'Materialize,css3,Javascript'
      ]
    },
    {
      title: 'Concord futbol',
      image: './img/projects/concord.png',
      imageAlt: 'Favorite concord photo',
      description: 'Ecommerce store Sportpro',
      badgeCaption: 'Node.js & Express',
      links: {
        github: 'https://github.com/jibsamGarcia?tab=repositories',
        instagram: 'https://www.instagram.com/garciajibsam/'
      },
      accomplishments: [
        'Express Handlebars & Bootstrap',
        'MongoDB & Mongoose',
    ...
    },
    {
      ...
      image: './img/projects/cap2.png',
      imageAlt: 'Code Photo',
      description: 'Es una application commerce store codificada en android studio y swift para IOS',
      badgeCaption: 'Node.js & Express',
      links: {
        github: 'https://github.com/jibsamGarcia?tab=repositories',
        instagram: 'https://www.instagram.com/garciajibsam/'
